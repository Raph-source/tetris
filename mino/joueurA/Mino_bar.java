...
public class Mino_bar extends Mino{
    public Mino_bar(EcouteurToucheA ecouteurToucheA){
        super(ecouteurToucheA);
        this.creer(Color.cyan);
    }

    public void setXY(int x, int y){
        this.block[0].x = x;        
        this.block[0].y = y;
        this.block[1].x = this.block[0].x - Block.TAILLE;
        this.block[1].y = this.block[0].y;
        this.block[2].x = this.block[0].x + Block.TAILLE;
        this.block[2].y = this.block[0].y;
        this.block[3].x = this.block[0].x + Block.TAILLE * 2;
    ...
    public void getDirection1(){
        ...
        this.tempB[3].x = this.block[0].x + Block.TAILLE * 2;
    ...
    public void getDirection2(){
        ...
        this.tempB[3].y = this.block[0].y + Block.TAILLE * 2;
